  ...
  return (
    <div className="Checkout-confirm">
      ...
      <div class="tab_container">
        ...
        <label for="tab1">
          <spans class="numberCircle">1</spans>
          <spans>Cart</spans>
        </label>

        <input id="tab2" type="radio" name="tabs" />
        <label for="tab2">
          <spans class="numberCircle">2</spans>
          <spans>Customer Information</spans>
        </label>

        <input id="tab3" type="radio" name="tabs" />
        <label for="tab3">
          <spans class="numberCircle">3</spans>
          <spans>Shipping</spans>
        </label>

        <input id="tab4" type="radio" name="tabs" checked />
        <label for="tab4">
          <spans class="numberCircle">4</spans>
          <spans>Payment</spans>
        </label>
          ...
          <form action="" method="post">
            ...
            <div class="form-cc">
              ...
              <div class="row-cc">
                ...
                <div class="cc-field">
                  <div class="cc-title">
                    CVV Code<spans class="numberCircle">?</spans>
                  </div>
